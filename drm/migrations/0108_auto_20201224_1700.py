# -*- coding: utf-8 -*-
# Generated by Django 1.9.12 on 2020-12-24 17:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('step', models.CharField(blank=True, max_length=20, null=True, verbose_name='流程中的步骤号')),
                ('type', models.CharField(blank=True, max_length=20, null=True, verbose_name='类型')),
                ('modelguid', models.CharField(blank=True, max_length=50, null=True, verbose_name='模型guid')),
                ('input', models.TextField(blank=True, null=True, verbose_name='输入参数')),
                ('output', models.TextField(blank=True, null=True, verbose_name='输出参数')),
